    ...
    while True:
        ...
        for x1, y1, x2, y2 in rects:
            ...
            if x1 <= 150:#sx
                ...
                circles = cv2.HoughCircles(sx, cv2.cv.CV_HOUGH_GRADIENT, 5,minDist=100,minRadius=18,maxRadius=25)
                print circles
                ...
                if circles is not None:
                    ...
                    for (x, y, r) in circles:
                        ...
                        cv2.circle(sx, (x, y), r, (0, 255, 0), 4)
                        #cv2.rectangle(sx, (x - 5, y - 5), (x + 5, y + 5), (0, 128, 255), -1)
                 
                    # show the output image
                    cv2.imshow("output", sx)
                    #cv2.waitKey(0)
